...
<form autocomplete="off" action="/action_page.php">
  ...
  <div class="autocomplete" style="width:300px;">
    <input id="analisis" type="text" name="analisis" placeholder="Analisis">
  </div>
  <input type="submit" formaction="main.php">
  
</form>
<br><br>
<button class="open-button" onclick="openAna()">Resultado</button>
<div class="form-popup" id="ana">
  <form action="/action_page.php" class="form-container">
    <h1>Analisis</h1>
    <input type="text" placeholder="Codigo Analisis" name="email" required>
    <input type="text" placeholder="Codigo Paciente " name="email" required>
    <input type="text" placeholder="Valor" name="email" required>
    <button type="submit" class="btn"formaction="main.php">Guardar e Imprimir</button>
...
autocomplete(document.getElementById("analisis"), elementos);
</script>
